		...
		<div className='bg-white py-24 sm:py-32'>
			<div className='mx-auto max-w-7xl px-6 lg:px-8'>
				<div className='mx-auto max-w-2xl lg:text-center'>
					...
					<p className='mt-2 text-3xl font-bold tracking-tight text-gray-900 [font-family:var(--font-playfair)] sm:text-4xl'>
						{t("headline")}
					</p>
					<p className='mt-6 text-lg leading-8 text-gray-600'>{t("sub-headline")}</p>
				</div>
