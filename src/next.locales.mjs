...
const availableLocales = localeConfig.filter(({ enabled }) => enabled)

// This gives an easy way of accessing all available locale codes
const availableLocaleCodes = availableLocales.map(({ code }) => code)
...
export { availableLocaleCodes, availableLocales, availableLocalesMap, defaultLocale }
